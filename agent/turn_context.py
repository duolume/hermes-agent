...
def build_turn_context(
    ...
    *,
    ...
    # Add user message unless this is a gateway continuation after a
    # plugin-injected tool result. In that case the next model call should
    # answer "what comes after this tool_result?" without appending an empty
    # user message, which some providers reject.
    is_continuation_kick = (
